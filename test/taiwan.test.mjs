...
test('Taiwan locale is selectable, stored, and sent through AI concierge routing',async()=>{
  ...
  assert.match(source,/message:q,language:lang,history:chatHistory\.slice\(-12\)/);
