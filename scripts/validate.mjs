...
const required=["index.html","assets/styles.css","assets/site-data.js","assets/app.js","assets/guide-knowledge.json","api/chat.js","assets/fonts/oxanium-latin.woff2","assets/images/hero.webp","assets/images/another-house-og-20260727.jpg","docs/research-sources.md","docs/concierge-knowledge-audit.md","vercel.json"];
...
const guideKnowledge=await readFile(resolve(root,"assets/guide-knowledge.json"),"utf8");
